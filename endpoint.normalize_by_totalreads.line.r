...
mappedCount<-unlist(countTable["MappedReads",])
...
allCategoryPosition$PositionCountFraction<-as.vector(1000000 * allCategoryPosition$PositionCount / mappedCount[allCategoryPosition$File])
...
png(paste0(outFile,".allPositionLine.normalizedByMapped.png"),width=width,height=height,res=300)
m<-ggplot() +
